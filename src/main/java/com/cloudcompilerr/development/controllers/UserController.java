...
public class UserController {
	...
	public ResponseEntity<PaginatedResult<UserDetails>> getAllUsers(
			@RequestParam(value = "page", required = false, defaultValue = "0") Integer page,
			@RequestParam(value = "per_page", required = false, defaultValue = "5") Integer perPage) throws Exception {
	...
	@GetMapping(value = "/users/{name}/gender/{gender}", produces = MediaType.APPLICATION_JSON_VALUE)
